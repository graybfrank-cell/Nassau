...
export async function GET(
  ...
  try {
    ...
    return apiError(err, "GET /api/game-rounds/[id]/nassau-bet");
  }
}
...
export async function POST(
  ...
  try {
    ...
    return apiError(err, "POST /api/game-rounds/[id]/nassau-bet");
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return apiError(err, "DELETE /api/game-rounds/[id]/nassau-bet");
  }
}
